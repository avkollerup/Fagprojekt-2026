...
from fagprojekt.hokus_pokus_inference import (patch_llama_attention, set_prefill, clear_hokuspokus,build_full_attention_matrix)
from fagprojekt.head_level_eval_utils import find_token_positions, get_random_messages
from fagprojekt.Hokus_pokus import build_mlp
...
"""
Simple test of hokus pokus attention.
