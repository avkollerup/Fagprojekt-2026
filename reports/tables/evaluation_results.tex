...
SVD Nyström uses its best $k=1$ (elbow-selected; $k=45$ gives a much worse and
unstable RMSE of $1.2716 \pm 1.1447$). All pairwise differences are statistically
significant ($p_\text{adj} < 0.05$, Wilcoxon signed-rank with Bonferroni correction).}
\label{tab:ranking}
\begin{tabular}{c l c c c}
\toprule
Rank & Method & Parameter & Mean RMSE & Std \\
\midrule
1 & SVD-V            & $k = 74$ & $0.1011$ & $0.0136$ \\
2 & Hokus Pokus      & 90 epochs & $0.1439$ & $0.0181$ \\
3 & SVD-K            & $k = 62$ & $0.1820$ & $0.0289$ \\
4 & SVD-KV (sep.)    & $k = 68$ & $0.1928$ & $0.0260$ \\
5 & SVD-KV (joint)   & $k = 68$ & $0.2477$ & $0.0304$ \\
6 & SVD Nyström      & $k = 1$    & $0.7589$ & $0.0263$ \\
7 & K-means          & 8 clusters & $0.7927$ & $0.0699$ \\
\bottomrule
\end{tabular}
\end{table}
